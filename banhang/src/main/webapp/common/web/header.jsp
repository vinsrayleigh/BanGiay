                            ...
                            <div class="col-lg-9 col-md-8">
                                <div class="header-top-right">
                                    <ul class="ht-menu">
                                         <!-- Begin Setting Area -->
                                         <li>
                                            <div class="btnChung"><span><a href="login-register.html">Đăng ký</a></span></div>
                                        </li>
                                        ...
                                        <!-- Begin Setting Area -->
                                        <li>
                                            <div class="ht-currency-trigger"><span>Tài khoản của tôi</span></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="logo pb-sm-30 pb-xs-30">
                                    <a href="index.html">
                                        <img src="<c:url value='/template/web/images/menu/logo/1.jpg' />"  alt="">
                                    </a>
                                </div>
                            </div>
                                    ...
                                    <ul class="hm-menu">
                                        ...
                                        <li class="hm-minicart">
                                            ...
                                            <div class="minicart">
                                                <ul class="minicart-product-list">
                                                    <li>
                                                        <a href="single-product.html" class="minicart-product-image">
                                                            <img src="<c:url value='/template/web/images/product/small-size/5.jpg' />"  alt="cart products">
                                                        </a>
                                                        <div class="minicart-product-details">
                                                            <h6><a href="single-product.html">Sản phẩm 1</a></h6>
                                                    ...
                                                    <li>
                                                        <a href="single-product.html" class="minicart-product-image">
                                                            <img src="<c:url value='/template/web/images/product/small-size/6.jpg' />"  alt="cart products">
                                                        </a>
                                                        <div class="minicart-product-details">
                                                            <h6><a href="single-product.html">Sản phẩm 2</a></h6>
                                                            <span>50,000 ₫ x 1</span>
                                                        </div>
                                                        <button class="close" title="Remove">
                                                            <i class="fa fa-close"></i>
                                                ...
                                                <p class="minicart-total">Tổng cộng: <span>100,000 ₫</span></p>
                                                <div class="minicart-button">
                                                    <a href="shopping-cart.html" class="li-button li-button-fullwidth li-button-dark">
                                                        <span>Xem giỏ hàng đầy đủ</span>
                                                    </a>
                                                    <a href="checkout.html" class="li-button li-button-fullwidth li-button-dark">
                                                        <span>Đặt hàng</span>
                                                    </a>
                                                </div>
                                            </div>
                                ...
                                <div class="hb-menu">
                                    <nav>
                                        <ul>
                                            ...
                                            <li class="megamenu-holder"><a href="#">Thương hiệu khác</a>                                                
