...
<ul class="sidebar-menu" data-widget="tree">
	...
	<li><a href="HomeManager.html"> <i class="fa fa-dashboard"></i><span>Trang
				tổng quan</span>
	</a></li>

	<li class="treeview"><a href="#"> <i class="fa fa-group"></i>
			<span>Quản lý nhân viên</span> <span class="pull-right-container"><i
				class="fa fa-angle-left pull-right"></i></span>
	</a>
		<ul class="treeview-menu">
			<li><a href="DanhSachNhanVien.html"><i
					class="fa fa-list-alt"></i> Danh sách nhân viên</a></li>
			<li><a href="ThemNhanVien.html"><i class="fa fa-user-plus"></i>
					Thêm nhân viên</a></li>
			<!-- <li><a href="#"><i class="fa fa-user-plus"></i></a></li> -->

			<li class="treeview"><a href="#"> <i
					class="fa fa-calculator"></i> <span> Quản lý lương nhân viên</span>
					<span class="pull-right-container"><i
						class="fa fa-angle-left pull-right"></i></span>
			</a>
				<ul class="treeview-menu">
					<li><a href="#"><i class="fa fa-circle-o"></i> Đăng ký
							lịch làm việc</a></li>
					<li><a href="#"><i class="fa fa-circle-o"></i> Điểm danh</a></li>
					<li><a href="#"><i class="fa fa-circle-o"></i> Thống kê
							lương</a></li>
				</ul></li>
		</ul></li>

	<li class="active treeview"><a href="#"> <i
			class="fa fa-truck"></i> <span>Quản lý nhà cung cấp</span> <span
			class="pull-right-container"><i
				class="fa fa-angle-left pull-right"></i></span>
	</a>
		<ul class="treeview-menu">
			<li class="active"><a href="DanhSachNhaCungCap.html"><i
					class="fa fa-list-alt"></i> Danh sách nhà cung cấp</a></li>
			<li><a href="ThemNhaCungCap.html"><i
					class="fa fa-plus-circle"></i> Thêm nhà cung cấp</a></li>
		</ul></li>

	<li class="treeview"><a href="#"> <i
			class="fa fa-expeditedssl"></i> <span>Quản lý tài khoản</span> <span
			class="pull-right-container"><i
				class="fa fa-angle-left pull-right"></i></span>
	</a>
		<ul class="treeview-menu">
			<li><a href="DanhSachTaiKhoanNhanVien.html"><i
					class="fa fa-list-alt"></i> Tài khoản nhân viên</a></li>
			<li><a href="DanhSachTaiKhoanKhachHang.html"><i
					class="fa fa-list-alt"></i> Tài khoản khách hàng</a></li>
		</ul></li>
	<li><a href="<c:url value='/admin-khachhang?page=1&pageItem=5&sortName=id&sortBy=asc'/> "> <i class="fa fa-file-text "></i>
			<span>Quản lí khách hàng</span>
	</a></li>
	<li><a href="DanhSachHoaDon.html"> <i class="fa fa-file-text "></i>
			<span>Quản lý hóa đơn</span>
	</a></li>
	<li><a
		href="<c:url value='/admin-khuyenmai?page=1&pageItem=5&sortName=id&sortBy=asc'/> ">
	...
	<li class="treeview "><a href="# "> <i class="fa fa-gear "></i>
			<span>Thành phần giao diện</span> <span class="pull-right-container "><i
				class="fa fa-angle-left pull-right "></i></span>
	</a>
		<ul class="treeview-menu ">
			<li class="treeview "><a href="# "> <i
			...
			<li class="treeview "><a href="# "> <i class="fa fa-edit "></i>
					<span>Forms</span><i class="fa fa-angle-left pull-right "></i></span>
			</a>
				<ul class="treeview-menu ">
